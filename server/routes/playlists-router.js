...
router.get('/search/:searchText/',auth.verify, PlaylistController.getPlaylistsBySearch)
router.get('/searchUser/:searchText', auth.verify, PlaylistController.getUserPlaylistsBySearch)
